...
public class RedisService {
    ...
    public Long getExpire(String key, TimeUnit unit) {
        if(null==key||null==unit){
            throw new BusinessExceptionIpm(10001, "key or time unit can't be empty!");
        }
    ...
    public Boolean setifAbsen(String key,Object value,long time,TimeUnit unit){
        ...
        if(null==key||null==value||null==unit){
            throw new BusinessExceptionIpm(100002,"key、value or unit can't be empty");
        }
    ...
    public long incrby(String key,long increment){
        if(null==key){
            throw new BusinessExceptionIpm(100003,"key can't be empty");
        }
...
//******************hash数据类型*********************
    ...
    public Long hIncrBy(String key,Object field,long increment){
        if (null==key||null==field){
            throw new BusinessExceptionIpm(4001004,"key or field 不能为空");
        }
    ...
    public Double zincrby(String key, double score, Object member) {
        if (null==key){
            throw new BusinessExceptionIpm(4001004,"key 不能为空");
        }
